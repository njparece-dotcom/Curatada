...
interface AutoValuationPromptModalProps {
  item: AutoItem;
  onClose: () => void;
...
export default function AutoValuationPromptModal({
  item,
  onClose,
  onValuationComplete,
}: AutoValuationPromptModalProps) {
        ...
        {step === "prompt" && (
          <div className="p-8 text-center">
            ...
            <p className="text-text-muted text-sm mb-8">
              Would you like an AI-powered market value estimate? We&apos;ll search KBB, CarGurus, and AutoTrader for comparable listings.
            </p>
        ...
        {step === "loading" && (
          <div className="p-10 text-center">
            ...
            <p className="text-text-muted text-sm">
              Searching KBB, CarGurus & AutoTrader for{" "}
